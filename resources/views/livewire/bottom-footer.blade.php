                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="footer-contact">
                        ...
                        <ul class="contact-lists" style="clear:both;">
                            ...
                            <li>
                                <span><b>Address:</b><span class="font-light">Sri Lanka, Kandy</span></span>
                            </li>
                            <li>
                                <span><b>Email:</b><span class="font-light"> dalpitiyathaun@gmail.com</span></span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="sub-footer">
        <div class="container">
            <div class="row gy-3">
                ...
                <div class="col-md-6">
                    <p class="mb-0 font-dark">© 2024, Tharun Dalpitiya.</p>
                </div>
            </div>
        </div>
    </div>
