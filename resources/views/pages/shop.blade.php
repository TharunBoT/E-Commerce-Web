                        ...
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                <div class="rating-details">
                                    <span class="font-light grid-content">{{$products->category->name}}</span>
                                ...
                                <div class="main-price">
                                    ...
                                    <div class="listing-content">
                                        <span class="font-light">{{$products->category->name}}</span>
                                        <p class="font-light">{{$products->short_description}}</p>
                                    </div>
                                    <h3 class="theme-color">${{$products->regular_price}}</h3>
